<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="CapturaPagosSuc.aspx.vb" Inherits="FinanciaDin.CapturaPagosSuc" %>
                    ...
                    <PanelCollection>
                        <dx:PanelContent>
                            <table align="center">
                                <tbody>
                                    <tr>
                                        <td align="center" colspan="3" class="auto-style7"># Pago</td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" colspan="3" class="auto-style2">
                                            <dx:ASPxComboBox ID="cbClientes" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2" DropDownStyle="DropDown" TextField="Nombre" ValueField="Id_Cliente" DropDownRows="8" Width="240px">
...
WHERE C.Liquidado = 0  AND C.estatusID = 1
ORDER BY Nombre "></asp:SqlDataSource>
                                            
                                        </td>
                                        <td align="center" colspan="3" class="auto-style2">
                                            <dx:ASPxComboBox ID="cbIdCredito" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DropDownRows="8" DropDownStyle="DropDown" TextField="ID" ValueField="ID_CLIENTE" Width="100px">
                                                <ListBoxStyle Wrap="False">
                                                </ListBoxStyle>
                                            </dx:ASPxComboBox>
...
FROM CREDITOS AS C 
WHERE C.Liquidado = 0  AND C.estatusID = 1"></asp:SqlDataSource>
                                        </td>
                                        <%--<td align="center" colspan="3" class="auto-style2">
                                            &nbsp;</td>--%>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="3" class="auto-style7">Sucursal</td>
                                        <td align="center" colspan="3">
                                            <dx:ASPxLabel ID="lblTxtCuota" runat="server" Font-Bold="True" Font-Size="Small" Text="Cuota Usual de Pago">
                                            </dx:ASPxLabel>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="center" colspan="3" class="auto-style7">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:FinanciaDinConnectionString %>" SelectCommand="SELECT [Id], [Descripcion] FROM [CATSUCURSALES] WHERE [Disponible] = 1" CacheDuration="10000"></asp:SqlDataSource>
                                        ...
                                        <td align="center" colspan="3">
                                            ...
                                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Font-Bold="True" Font-Size="Medium" Text="$ ">
                                            </dx:ASPxLabel>
                                            <dx:ASPxLabel ID="lblCuota" runat="server" Font-Bold="True" Font-Size="Medium">
                                            </dx:ASPxLabel>
                                        ...
                                        <td align="center" colspan="3" valign="middle">
                                            ...
                                            <dx:ASPxSpinEdit ID="txtMonto" runat="server" Number="0" DisplayFormatString="c" Height="20px" HorizontalAlign="Left" Width="120px" AutoPostBack="True" NumberType="Integer">
                                    ...
                                    <tr align="center" valign="middle">
                                        ...
                                        <td colspan="5">
                                            <dx:ASPxButton ID="btnTabla" runat="server" Text="Mostrar/Ocultar tabla"></dx:ASPxButton>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
