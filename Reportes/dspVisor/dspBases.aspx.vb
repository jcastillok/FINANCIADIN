Public Class dspBases

    Inherits System.Web.UI.Page

    Public crReporteDocumento As New crBases
    ...
    Private Sub dspEntradasEsperadas_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try
            ...
            If DirectCast(Session("Bases"), System.Data.DataSet).Tables.Count <> 0 Then

                crReporteDocumento.SetDataSource(DirectCast(Session("Bases"), System.Data.DataSet))
