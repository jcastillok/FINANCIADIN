Public Class dspCarteraSL
    ...
    Private Sub dspCartera_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try
            ...
            If DirectCast(Session("CarteraSL"), System.Data.DataSet).Tables.Count <> 0 Then

                crReporteDocumento.SetDataSource(DirectCast(Session("CarteraSL"), System.Data.DataSet))
