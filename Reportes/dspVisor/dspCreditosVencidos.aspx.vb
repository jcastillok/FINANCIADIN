Public Class dspCreditosVencidos

    Inherits System.Web.UI.Page

    Public crReporteDocumento As New crCarteraVencida

    Private Sub dspCreditos_Unload(sender As Object, e As System.EventArgs) Handles Me.Unload
    ...
    Private Sub dspCreditos_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try

            If DirectCast(Session("CarteraVencida"), System.Data.DataSet).Tables.Count <> 0 Then

                crReporteDocumento.SetDataSource(DirectCast(Session("CarteraVencida"), System.Data.DataSet))
