Public Class dspCreditos

    Inherits System.Web.UI.Page

    Public crReporteDocumento As New crCreditos
    ...
    Private Sub dspCreditos_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try
            ...
            If DirectCast(Session("Creditos"), System.Data.DataSet).Tables.Count <> 0 Then

                crReporteDocumento.SetDataSource(DirectCast(Session("Creditos"), System.Data.DataSet))
