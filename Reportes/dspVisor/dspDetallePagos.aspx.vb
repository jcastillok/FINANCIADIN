Public Class dspDetallePagos

    Inherits System.Web.UI.Page

    Public crReporteDocumento As New crDetallePagos

    Private Sub dspDetallePagos_Unload(sender As Object, e As System.EventArgs) Handles Me.Unload
        crReporteDocumento.Close()
        crReporteDocumento.Dispose()
        CrystalReportViewer1.Dispose()
        GC.Collect()
    End Sub
    Private Sub dspDetallePagos_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try

            If DirectCast(Session("DetallePagos"), System.Data.DataSet).Tables.Count <> 0 Then

                crReporteDocumento.SetDataSource(DirectCast(Session("DetallePagos"), System.Data.DataSet))
