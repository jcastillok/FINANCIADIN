Public Class dspMovtos

    Inherits System.Web.UI.Page

    Public crReporteDocumento As New crMovtos
    ...
    Private Sub dspDetallePagos_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try
            ...
            If DirectCast(Session("Movtos"), System.Data.DataSet).Tables.Count <> 0 Then

                crReporteDocumento.SetDataSource(DirectCast(Session("Movtos"), System.Data.DataSet))
