...
Public Class crDetallePagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinanciaDin.crDetallePagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetallePagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetallePagos = New crDetallePagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
