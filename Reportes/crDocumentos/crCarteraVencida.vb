...
Public Class crCarteraVencida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinanciaDin.crCarteraVencida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCarteraVencida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCarteraVencida = New crCarteraVencida()
        rpt.Site = Me.Site
        Return rpt
    End Function
