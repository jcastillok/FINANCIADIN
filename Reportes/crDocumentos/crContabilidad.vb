...
Public Class crContabilidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinanciaDin.crContabilidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrContabilidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crContabilidad = New crContabilidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
