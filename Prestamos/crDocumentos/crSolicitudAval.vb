...
Public Class crSolicitudAval
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinanciaDin.crSolicitudAval.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSolicitudAval
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSolicitudAval = New crSolicitudAval()
        rpt.Site = Me.Site
        Return rpt
    End Function
