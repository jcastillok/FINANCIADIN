Public Class dspContrato

    Inherits System.Web.UI.Page

    Public crReporteDocumento As New crContrato

    Private Sub dspContrato_Unload(sender As Object, e As System.EventArgs) Handles Me.Unload
        'crReporteDocumento.Close()
        'crReporteDocumento.Dispose()
        'CrystalReportViewer1.Dispose()
    End Sub

    Private Sub dspContrato_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try
            ...
            If DirectCast(Session("ContratoDataSet"), System.Data.DataSet).Tables.Count <> 0 Then
                ...
                Dim file As String = System.IO.Path.GetTempPath & "Contrato" & variables(2).ToString.Replace(" ", "") & ".PDF"
